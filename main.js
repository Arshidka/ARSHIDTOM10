...
nocache('../message/help.js', module => console.log(color('[WATCH]', 'cyan'), color(`'${module}'`, 'green'), 'File is updated!'))
	...
	console.log(color(figlet.textSync('TOM SER OFC', {
		font: 'Standard',
	...
	console.log(color('[TOM ]', 'cyan'), color('WELCOME', 'white'))
	console.log(color('[SER]', 'cyan'), color('BOT RUNNING', 'yellow'))
	bosco.browserDescription = ["TOM  SER OFC - [TOM -SER]", "edge", "3.0.0"];
...
`
   ...
   remoteJid: "0@s.whatsapp.net"},message: {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "Alphabot", "caption": `🍭 𝑻𝑶𝑴-𝑺𝑬𝑹 🍭 `, 'jpegThumbnail': fs.readFileSync(`ds.jpg`)}}}
