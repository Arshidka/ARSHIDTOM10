...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: '𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 ⁩ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩😖',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
                case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩😫"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - 😫"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩😫"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩😫"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😣"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😣"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n- ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩😣"; break;
            ...
            switch(jamss){
                ...
                case 4: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
                case 5: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
                ...
                case 12: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ⁩"; break;
                case 13: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ😢"; break;
                case 14: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ😥"; break;
                case 15: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
                case 16: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ😖"; break;
                case 17: jamss = "ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ😫"; break;
                case 18: jamss = "‍ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
                case 19: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
                case 20: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ🥺"; break;
                case 21: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ😞"; break;
                case 22: jamss = "ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ💔⁩"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918590634460?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/тσм ⁩✘ ➫➬➭ ${anji}`, orderTitle: `𒈒 ī.ᴀᴍ/тσм⁩ 𒈒➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 77777, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/тσм⁩ ✘ ➫➬➭ ${anju}`, orderTitle: `𒈒 ī.ᴀᴍ/тσм⁩ 𒈒➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 359996400, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ⁩ ✘ ➫➬➭ ${anjh}`, orderTitle: `𒈒 ī.ᴀᴍ/ꪶ͢тσм-𝐒𝐄𝐑-𝐁𝐎𝐓ꫂ⁩ 𒈒➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
╚༄ ${prefix}sᴇᴅ ʟʏғᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ : _mhd_arshid 
 ╚༄
╔✘*ᴛʀʏ ᴀɴʏ ᴛʜɪɴɢ✘
║༊ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║༊ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
...
༆TOM SER༄
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "ꪶ͢тσм ѕєяꫂ⁩", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
let pi=denz["prepareMessageFromContent"](from,{
"listMessage":{
"title":"ʜɪ ʙʀᴏ ᴛʜɪs ɪs ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩ ᴍᴇɴᴜ","description":`${""}
     ʜɪ ʙʀᴏ  ${pushname}     
╔༆ᴄʀᴇᴀᴛᴏʀ⟼ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩
║༄ᴠᴇʀsɪᴏɴ⟼3.0
║༄ʙᴏᴛɴᴀᴍᴇ⟼ī.ᴀᴍ/ꪶ͢тσм ѕєяꫂ⁩
║༄ᴘʀᴇғɪx⟼(ᴍᴜʟᴛɪ ᴘʀᴇғɪx)
...
╰───────────────𒈒
 ...
 ꪶ͢тσм ѕєяꫂ⁩💝
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©ī.ᴀᴍ/тσм ѕєяꫂ⁩", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* : ꪶ͢тσм ѕєяꫂ⁩
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ꪶ͢тσм ѕєяꫂ⁩
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @918590634460
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜
*ᴘʀɪᴠᴀᴛᴇ ʙᴏᴛ ᴀɴᴜ ᴠʀᴏ*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢тσм ѕєяꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg')}}})
break		
//Now
case 'nuliskiri':
...
└ ${prefix}ytmp4 [link yt] = Video`})
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					if (err) return denz.sendMessage(from, `root @ToM -Ser:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
				...
				case 'liststicker':
					...
					denz.sendMessage(from, `𝚃𝙷𝙸𝚂 𝙲𝙾𝙼𝙼𝙰𝙽𝙳 𝙸𝚂 𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 тσм ѕєя 🌚🎗️`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ToM  ser",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/918590634460?text=Hi Bro"}}})
	}
    }
    }
    }
